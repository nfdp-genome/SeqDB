# Cloud Deployment Guide — NFDP Genomic Deposition System
...
MINIO_ENDPOINT = "use google bucket"
MINIO_SECURE = True
...
- **FAIR compliance:** All data gets persistent identifiers (NFDP accessions)
